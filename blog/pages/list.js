...
import { Col, Row, List, Breadcrumb,Timeline, Card } from 'antd';
    ...
    <div>
      ...
      <Row className="comm-main" type="flex" justify="center">
        ...
        <Col className="comm-right" xs={24} sm={24} md={16} lg={18} xl={14}>
          ...
          <Timeline mode={'left'} className={'show-timline'}>
            {mylist.map((item)=>{
              return (
                <Timeline.Item label={item.addTime} color={'pink'} position={'left'}>
                  {item.title}
                </Timeline.Item>
              )
            })}
